...
__Step 2__: After the installation, the user should go to the plugins page (Admin -> Plugins) and hit Settings under Karma Score plugin. Then, set the Dao Name as registered at [Show Karma](https://showkarma.xyz).
